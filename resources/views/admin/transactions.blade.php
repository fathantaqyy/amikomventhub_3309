            ...
            <tbody class="divide-y border-t">
                @forelse($transactions as $trx)
                    ...
                    <tr class="hover:bg-slate-50/50 transition">
                        <td class="px-8 py-6">
                            <span class="font-mono font-bold px-3 py-1 rounded-lg text-sm text-indigo-600 bg-indigo-50">
                                {{ $trx->order_id }}
                            </span>
                        </td>
                        ...
                        <td class="px-8 py-6">
                            ...
                            @elseif(in_array($status, ['capture']))
                                <span class="px-3 py-1 bg-blue-100 text-blue-700 rounded-lg text-xs font-bold uppercase ring-1 ring-blue-200">
                                    Capture
                                </span>

                            @elseif(in_array($status, ['expire','expired']))
                                <span class="px-3 py-1 bg-gray-100 text-gray-700 rounded-lg text-xs font-bold uppercase ring-1 ring-gray-200">
                                    Expired
                                </span>

                            @elseif(in_array($status, ['deny','cancel','failure','failed']))
